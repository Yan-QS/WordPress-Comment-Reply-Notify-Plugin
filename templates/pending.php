...
<div style="font-family:Arial,Helvetica,sans-serif;color:#333;line-height:1.6;">
    ...
    <p>操作： <a href="<?php echo esc_url(admin_url("comment.php?action=approve&c={$comment_id}#wpbody-content")); ?>">批准</a> | <a href="<?php echo esc_url(admin_url("comment.php?action=trash&c={$comment_id}#wpbody-content")); ?>">移至回收站</a></p>
